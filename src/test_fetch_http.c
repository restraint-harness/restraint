...
static void test_fetch_http_success(void) {
    RunData *run_data;
...
static void test_fetch_http_fail(void) {
    RunData *run_data;
...
static void test_fetch_http_bad_archive(void) {
    RunData *run_data;
...
int main(int argc, char *argv[]) {
    ...
    g_test_add_func("/fetch_http/success", test_fetch_http_success);
    g_test_add_func("/fetch_http/bad_archive", test_fetch_http_bad_archive);
    g_test_add_func("/fetch_http/fail", test_fetch_http_fail);
    return g_test_run();
}
